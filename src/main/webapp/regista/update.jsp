				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteUpdateRegistaServlet" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<input type="text" name="cognome" id="cognome" class="form-control" placeholder="Inserire il cognome" value="${update_regista_attr
									.cognome }" required>
								</div>
							...
							<div class="col-12">
								<input type="hidden" value="${update_regista_attr.id}" name="id">
